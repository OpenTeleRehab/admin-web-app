...
export const SETTING_PHC_SERVICE = SETTING + '#phc_service';
...
export const SETTING_PHC_WORKER_GUIDANCE = SETTING + '#phc_worker_guidance';
...
export const SETTING_SCREENING_QUESTIONNAIRE = SETTING + '#screening_questionnaire';
...
export const PHC_WORKER = '/phc-worker';
