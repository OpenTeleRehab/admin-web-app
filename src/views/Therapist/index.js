...
const Therapist = ({ translate }) => {
  ...
  let columns = [
    ...
    { name: 'therapist_profession', title: translate('common.profession') },
  ...
  const columnExtensions = [
    ...
    { columnName: 'therapist_profession', wordWrapEnabled: true },
      ...
      <CustomTable
        ...
        rows={therapists.map(user => {
          ...
          return {
            ...
            email: user.email,
            therapist_profession: getProfessionName(user.profession_id, professions),
