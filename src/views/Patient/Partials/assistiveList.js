...
const AssistiveList = ({ translate }) => {
  ...
  }, [currentPage, pageSize, dispatch, filters, searchValue, orderBy, fromDate, toDate, country, profile]);
  ...
  return (
    <div className="mt-4">
      <CustomTable
        ...
        hover="hover-primary"
        showCountryFilter={profile.type === USER_GROUPS.ORGANIZATION_ADMIN}
        showDateFilter={true}
...
AssistiveList.propTypes = {
  translate: PropTypes.func
};

export default AssistiveList;
